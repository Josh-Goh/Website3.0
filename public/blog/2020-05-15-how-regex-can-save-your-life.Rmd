...
Let's see how we can put REGEX to use!
```{python}
import re
...
This is just a small example to illustrate the point that REGEX serves a variety of functions that can help in a multitude of ways. 

## Regular Expressions: Conclusion 
REGEX might save your life or it might not. Learn REGEX and tell me how it goes. If it saves your life, let me know. If it doesn't, don't bother contacting me.
